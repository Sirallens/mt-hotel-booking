...
class HBS_Public {
    ...
    public function enqueue_assets() {
        ...
        wp_enqueue_style(
            'hbs-public',
            $base_url . 'css/hotel-booking.css',
            array(),
            '0.1.0'
        );
    ...
    public function render_floating_form() {
        ...
        ?>
        <div id="hbs-floating-form" aria-label="<?php echo esc_attr__( 'Formulario rápido de reservación', 'hotel-booking-system' ); ?>">
            <form method="get" action="<?php echo $booking_url; ?>">
                <label style="display:inline-block;">
                    <span style="display:block;font-size:11px;"><?php echo esc_html__( 'Llegada', 'hotel-booking-system' ); ?></span>
                    <input type="date" name="check_in_date" value="<?php echo esc_attr( $today ); ?>" min="<?php echo esc_attr( $today ); ?>">
                </label>

                <label style="display:inline-block;">
                    <span style="display:block;font-size:11px;"><?php echo esc_html__( 'Noches', 'hotel-booking-system' ); ?></span>
                    <input type="number" name="nights" value="1" min="1" style="width:70px;">
                </label>

                <label style="display:inline-block;">
                    <span style="display:block;font-size:11px;"><?php echo esc_html__( 'Adultos', 'hotel-booking-system' ); ?></span>
                    <input type="number" name="adults" value="1" min="1" style="width:70px;">
                </label>

                <label style="display:inline-block;">
                    <span style="display:block;font-size:11px;"><?php echo esc_html__( 'Niños', 'hotel-booking-system' ); ?></span>
                    <input type="number" name="kids" value="0" min="0" style="width:70px;">
                </label>

                <button type="submit">
                    <?php echo esc_html__( 'Reservar', 'hotel-booking-system' ); ?>
                </button>
            </form>
        </div>
        <?php
