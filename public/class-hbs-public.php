        ...
        <div id="hbs-floating-form"
            ...
            <form method="get" action="<?php echo $booking_url; ?>">
                <label style="display:inline-block;">
                    <span
                        style="display:block;font-size:11px;"><?php echo esc_html__('Llegada', 'hotel-booking-system'); ?></span>
                ...
                <label style="display:inline-block;">
                    <span
                        style="display:block;font-size:11px;"><?php echo esc_html__('Noches', 'hotel-booking-system'); ?></span>
                    <input type="number" name="nights" value="1" min="1" style="width:70px;">
                </label>

                <label style="display:inline-block;">
                    <span
                        style="display:block;font-size:11px;"><?php echo esc_html__('Adultos', 'hotel-booking-system'); ?></span>
                    <input type="number" name="adults" value="1" min="1" style="width:70px;">
                </label>

                <label style="display:inline-block;">
                    <span
                        style="display:block;font-size:11px;"><?php echo esc_html__('Niños', 'hotel-booking-system'); ?></span>
